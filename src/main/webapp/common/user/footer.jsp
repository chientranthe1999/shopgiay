			  ...
			  <div class=" text-center text-md-start mt-5">
				<div class="row mt-3">
				  <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
					<h6 class="text-uppercase fw-bold mb-4"><i class="fas fa-gem me-3"></i>Candy Store</h6>
					<p>
					  Chúng tôi chuyên cung cấp mẫu giày,dép chất lượng
					</p>
				  </div>
				  ...
				  <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
					...
					<p><a href="#!" class="text-reset">Miễn phí đổi trả</a></p>
					<p><a href="#!" class="text-reset">Lỗi 1 đổi 1</a></p>
				  </div>
				  <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
					<h6 class="text-uppercase fw-bold mb-4">Liên hệ</h6>
					<p><i class="fas fa-home me-3"></i> Bắc Từ Liêm, Hà Nội, Việt Nam</p>
					<p><i class="fas fa-envelope me-3"></i> candysoree@gmail.com</p>
					<p><i class="fas fa-phone me-3"></i> + 0966645612</p>
					<p><i class="fas fa-print me-3"></i> + 0384792861</p>
				  </div>
				</div>
			  </div>
			</section>
